...
By accessing or using Firexcheck ("Service", "Platform", "we", "us", or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.
...
**Authority:** By registering, you represent that you have the authority to bind your organization to these Terms.

**Prohibited Users:** You may not use the Service if:
...
**Payment:** Subscriptions are billed monthly or annually in advance via Stripe.
...
**Failed Payments:** Service may be suspended if payment fails. You remain responsible for unpaid fees.

### 5.3 Free Trial

We may offer a free trial:
- Trial duration specified at signup
...
- Cancel through account settings or by contacting support
...
- Manage fire extinguisher inventories
- Track inspections and maintenance
- Generate compliance reports
- Send notifications to authorized personnel
...
- Contains confidential information you don't own

## 7. Data and Privacy

### 7.1 Your Data

**Ownership:** You retain all rights to data you upload ("Your Data").

**License:** You grant us a license to use Your Data to provide the Service.

**Responsibility:** You are responsible for:
- Accuracy of Your Data
- Legal compliance of Your Data
...
**Data Security:** We implement reasonable security measures but cannot guarantee absolute security.

**Data Location:** Data may be stored and processed in various locations.

### 7.3 Data Deletion

Upon account termination:
- You have 30 days to export Your Data
- We delete Your Data within 90 days
...
The Service is a management tool. It does not:
- Replace professional fire safety inspections
- Constitute legal or safety advice
- Guarantee regulatory compliance

**You remain responsible for fire safety compliance.**
...
**Planned Maintenance:** We may perform maintenance with reasonable notice.

**Unplanned Downtime:** We are not liable for service interruptions.
...
### 14.1 Fire Safety Regulations

**Your Responsibility:** You are responsible for:
- Complying with local fire safety laws
- Conducting proper inspections
- Maintaining equipment
- Training personnel

**Our Role:** We provide tools to help manage compliance, but do not guarantee compliance.

### 14.2 Data Protection

We comply with applicable data protection laws (GDPR, CCPA). See our [Privacy Policy](PRIVACY_POLICY.md).

## 15. Dispute Resolution

### 15.1 Informal Resolution

Before filing a claim, contact us to resolve the dispute informally.

### 15.2 Arbitration

**Binding Arbitration:** Disputes will be resolved through binding arbitration.
...
**To You:** Via email to your registered address
**To Us:** Via email to legal@firexcheck.com

### 16.7 Survival

Provisions that should survive termination (liability, indemnification, disputes) remain in effect.
...
**Email:** info@firexcheck.com
**Legal Inquiries:** info@firexcheck.com
**Address:** [Your Company Address]
**Website:** https://firexcheck.com

## 19. Accessibility

We are committed to making the Service accessible. Contact us if you encounter accessibility issues.

## 20. Export Controls

You may not use or export the Service in violation of export control laws.
